    ...
    $.fn.imageUploader = function (options) {
        ...
        plugin.init = function () {
            ...
            plugin.each(function (i, wrapper) {
                ...
                $container.find('.uploaded').append(`
                  <div class="uploaded-image rounded rounded-4 position-relative">
                    <div class="upload-text rounded rounded-4 position-absolute d-flex align-items-center justify-content-center h-100 w-100">
        ...
        let createContainer = function () {
            ...
            let $container = $('<div>', {class: 'image-uploader bg-white rounded rounded-4'});
            ...
            let $uploadedContainer = $('<div>', {class: 'uploaded row d-flex flex-row-reverse g-0'}).appendTo($container),

                // Create the text container and append it to the container
                $textContainer = $('<div>', {
                    class: 'upload-text  bg-white rounded rounded-4'
                }).appendTo($container),

                // Create the icon and append it to the text container
                $i = $('<i>', {class: 'fa-regular fa-arrow-up-from-bracket'}).appendTo($textContainer),
        ...
        let createImg = function (src, id, preloaded) {
            ...
            let $container = $('<div>', {class: 'uploaded-image rounded rounded-4 col-12 col-lg-3'}),

                // Create the img tag
                $img = $('<img>', {class:'img-thumbnail rounded rounded-4', src: src}).appendTo($container),

                // Create the delete button
                $button = $('<button>', {class: 'delete-image btn btn-sm rounded-circle btn-danger text-white position-absolute top-0 end-0 m-3'}).appendTo($container),

                // Create the delete icon
                $i = $('<i>', {class: 'fa-solid fa-trash-xmark'}).appendTo($button);
